...
type ProjectId = (typeof PROJECTS_META)[number]['id']
...
const Projects: React.FC = () => {
  ...
  const handleImageClick = (projectIndex: number, image: string): void => {
    ...
    const galleryImages = PROJECTS_META[projectIndex].gallery
    ...
    <Section id="projects">
      ...
      <div>
        {PROJECTS_META.map((project, index) => {
          ...
          const technologies = t(`projects.items.${id}.technologies`, {
            returnObjects: true,
          }) as string[]
      ...
      {selectedProject !== null && (
        <GalleryModal
          ...
          images={
            PROJECTS_META[selectedProject].gallery || [
              PROJECTS_META[selectedProject].image,
            ]
          }
