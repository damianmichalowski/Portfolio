...
const MetaTags = ({
  ...
  image = `${window.location.origin}/assets/projects/portfolio.png`,
  ...
  return (
    <Helmet>
      ...
      <meta name="keywords" content="frontend developer, react, typescript, javascript, tailwind css, web development, portfolio, damian michałowski, poland" />
